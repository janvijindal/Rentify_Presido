...
const LandDetails = () => {
  ...
  return (
    <div class="container-fluid primary-color mt-10">
       <section class="row">
       <div class=" col-md-12 d-flex justify-content-center">
          <div class="shadow px-4 rounded-3 w-75">
            <div class='text-left'>
      <h2 className="text-center my-3">Enter Land Details for Selling</h2>
      <form onSubmit={handleSubmit}>
        ...
        <button style={{"background-color":"#6F4DF5"}} class='button mb-3 rounded-2 w-100 text-white p-1' type="submit">Submit</button>
      </form>
      </div>
      </div></div>
      </section>
