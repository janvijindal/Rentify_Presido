...
export default function RegistrationComponent() {
  ...
  const collectData = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        setErrorMessage(
          "User already exists with this username or password. Try Again "
        );
  ...
  return (
    <div class="container-fluid primary-color register opacity-90">
      <section class="">
        <div class=" vh-100 flex justify-center items-center">
          <div class="shadow px-4 rounded-3 bg-black/50 ">
            <div class="text-left">
              <h4 class="mb-3 text-center text-white text-3xl text-bold my-3">
                Register Now
              </h4>
              ...
              <form onSubmit={collectData}>
                <button
                  ...
                  class="button rounded-2 w-100 text-white p-1"
                  type="submit"
                >
                  SIGN UP
                </button>
              ...
              <div className="text-bold text-white text-center my-3">
