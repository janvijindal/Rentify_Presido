...
function Login() {
  ...
  return (
    <div className="container-fluid primary-color login opacity-90">
      <section className=" row">
        {/* left */}
        <div className="vh-100 flex justify-center items-center">
          <div className="shadow p-5 rounded-3 w-50 bg-black/50">
            <div className="text-left">
              <h4 className="mb-4 text-center text-white text-3xl text-bold">
                Login Now
              </h4>
              ...
              <div className="">
                ...
                <div className=" p-3 text-white text-center text-bold ">
                  Don't have an account?{" "}
                  <a href="/" className="link">
                    <Link
                      to="/signup"
                      className="text-red-500 text-xl text-bold"
                    >
                      Sign Up
                    </Link>
                  </a>
